...
export default function ViewPanelist({ profile }: { profile: Panelist }) {
  ...
  // const profile = {
  //   photo:
  //     "https://res.cloudinary.com/dx3xhdaym/image/upload/v1740632216/panelist/ftjqu0ydurmtjj0nyfcn",
  //   name: "Radoniaina",
  //   position: "Développeur Web",
  //   organization: "E-media",
  //   email: "radoniaina@gmail.com",
  //   phone: "0329190796",
  //   country: "Madagascar",
  //   linkedIn: "https://www.linkedin.com/in/radoniaina",
  //   description:
  //     "Passionné par le développement web et les nouvelles technologies, j'aime créer des applications performantes et intuitives.",
  // };
