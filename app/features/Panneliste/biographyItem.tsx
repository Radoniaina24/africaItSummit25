...
const BiographyItem = ({ faqData }: { faqData: FaqData }) => {
  const { activeFaq, id, handleFaqToggle, quest, ans, ans2 } = faqData;
    ...
    <>
      <div className="flex flex-col border-b border-stroke last-of-type:border-none">
        <button
          ...
          className="text-md flex cursor-pointer items-center justify-between px-6 py-5 font-medium text-black dark:text-white lg:px-9 lg:py-7.5"
        >
          {quest}
